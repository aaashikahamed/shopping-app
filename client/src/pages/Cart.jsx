          ...
          <div className="col-span-12 md:col-span-5 lg:col-span-4 ">
            <div className="bg-white p-5 shadow-md border">
              ...
              <div className="flex justify-between text-lg mt-5">
                ...
                <span>Rs. {totalRegularPrice.toLocaleString()} /=</span>
              </div>
              {discount > 0 && (
                <div className="flex justify-between text-lg mt-5">
                  <span>Discount</span>
                  <span className='text-green-600 font-semibold'>- Rs. {discount.toLocaleString()} /=</span>
                </div>
              )}
              ...
              {discount > 0 && (
                <div className="text-xl mt-5 font-semibold text-green-600 text-center">
                  <span>You will save Rs. <span>{discount.toLocaleString()} /=</span> on this order</span>
                </div>
              )}
            </div>
          </div>
