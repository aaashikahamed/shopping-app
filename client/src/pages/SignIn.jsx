    ...
    return(
        ...
        <div className="flex bg-violet-400 p-5 shadow-xl rounded-2xl border">
          ...
          <div className="sm:w-full px-2 md:px-12">
            ...
            <p className='mt-5 '>Dont have an account, <Link to='/signup' className='text-blue-800 font-bold hover:underline cursor-pointer whitespace-nowrap'>Register</Link></p>
